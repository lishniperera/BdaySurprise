...
const config = {
    name: "Baba", // actual name of the recipient (Mandatory)

    nickname: "Manika❤️", // nickname(optional)
...
function carousel() {
  var i;
  var x = document.getElementsByClassName("bd-pic");
  ...
  setTimeout(carousel, 4000); // Change image every 2 seconds
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Many Happy returns of the day";
